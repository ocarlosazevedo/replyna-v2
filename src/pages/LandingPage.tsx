          ...
          <div className="pricing-grid">
            {[
              ...
              },
              {
                ...
                emails: '900',
                lojas: '3',
                features: ['Integração com 3 lojas', '900 e-mails/mês inclusos', 'Até 2 membros na equipe', 'R$0,70 por e-mail extra'],
                highlight: true,
              },
              {
                name: 'Scale',
                ...
                emails: '1.500',
                lojas: '5',
                features: ['Integração com 5 lojas', '1.500 e-mails/mês inclusos', 'Até 5 membros na equipe', 'R$0,60 por email extra'],
                highlight: false,
              },
              {
                name: 'High Scale',
                ...
                emails: '3.000',
                lojas: '10',
                features: ['Integração com 10 lojas', '3.000 e-mails/mês inclusos', 'Até 10 membros na equipe', 'R$0,50 por email extra'],
                highlight: false,
              },
              {
                name: 'Enterprise',
                ...
                emails: 'Ilimitado',
                lojas: 'Ilimitado',
                features: ['Lojas ilimitadas', 'Emails ilimitados', 'Equipe ilimitada', 'Sem custo extra por email'],
                highlight: false,
              },
            ].map((plan, i) => (
