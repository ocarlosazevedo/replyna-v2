...
-- ORDER BY jobname;
--
-- Você deve ver APENAS estes jobs:
-- 1. fetch-emails-cron (*/5 * * * *)
-- 2. process-queue-cron (* * * * *)
-- 3. aggregate-queue-metrics-cron (*/5 * * * *)
-- 4. cleanup-completed-jobs-cron (0 3 * * *)
-- 5. cleanup-stuck-jobs-cron (*/15 * * * *)
-- 6. cleanup-cron-logs (0 4 * * *)
-- 7. cleanup-processing-logs (0 3 * * *)
-- 8. reset-rate-limits (0 * * * *)
-- =============================================================================
